...
def test_factory_builds_edit_model():
    model = RouteModelFactory.build_edit_model_by_name("bestsofar_feb2023_trim")
...
def test_factory_builds_construction_model():
    model = RouteModelFactory.build_construction_model_by_name("bestsofar_feb2023")
...
def test_factory_role_mismatch_raises():
    ...
    with pytest.raises(TypeError):
        RouteModelFactory.build_construction_model_by_name("bestsofar_feb2023_trim")
